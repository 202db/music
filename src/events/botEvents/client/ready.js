...
module.exports.run = async (client) => {
    ...
    setInterval(async () => {
        ...
        const status = [
            { type: ActivityType.Playing, name: "Créer avec 💖 par 202.sql" },
            { type: ActivityType.Listening, name: "/help | @202.sql" },
            { type: ActivityType.Watching, name: `Dans ${servers} Serveurs ${members} Membres` },
            { type: ActivityType.Listening, name: `Musique 🎧` },
        ];
