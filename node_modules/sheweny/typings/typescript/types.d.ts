...
/** **** UTIL ******/
export declare type CustomId = Array<string | RegExp>;
export declare type Manager = ButtonsManager | CommandsManager | EventsManager | InhibitorsManager | ModalsManager | SelectMenusManager;
export declare type CommandManagerRegisterStrategy = typeof COMMANDS_MANAGER_STRATEGY.set | typeof COMMANDS_MANAGER_STRATEGY.create;
export declare type Structure = Button | Command | Event | Inhibitor | Modal | SelectMenu;
/**
 * Commands types
 */
export declare type CommandData = SlashCommandData | ContextMenuUserData | ContextMenuMessageData | MessageData;
export declare type MessageCommandPrefix = string | ((msg: Message) => Awaitable<string>);
